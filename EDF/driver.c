...
int main(int argc, char *argv[])
{
    ...
    int deadline; // Deadline (prazo final) da tarefa
    ...
    while (fgets(task,SIZE,in) != NULL) {
        ...
        deadline = atoi(strsep(&temp, ",")); // Extrai e converte o deadline para inteiro

        add(name,priority,burst, deadline); // Adiciona a tarefa à fila de prioridade
